"""
This script is called by the plugin-wrapper, create_fabfed_config_file.js, which passes down the
...
from create_fabfed_config_file import create_fabfed_config_file
...
plugin = create_fabfed_config_file(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
